 ...
 * Clase que maneja la carga del JSON y la creacion de la tabla Hash
 * a partir de este.
 */
...
public class JSONLoader {
    ...
    /**
     * Inserta una secuencia de preguntas, en el árbol, empezando en nodoActual 
     * (generalmente la raíz).
    ...
    /**
     * Carga la tabla hash desde el mismo archivo JSON.
     */
